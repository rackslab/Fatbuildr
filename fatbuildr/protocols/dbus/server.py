...
class FatbuildrInterface(InterfaceTemplate):
    ...
    def ArtefactBinaries(
        self, instance: Str, fmt: Str, distribution: Str, src_artefact: Str
    ) -> List[Structure]:
        ...
        return DbusArtefact.to_structure_list(
            self.implementation.artefact_bins(
                instance, fmt, distribution, src_artefact
            )
        )

    def ArtefactSource(
        self, instance: Str, fmt: Str, distribution: Str, bin_artefact: Str
    ) -> Structure:
        ...
        return DbusArtefact.to_structure(
            self.implementation.artefact_src(
                instance, fmt, distribution, bin_artefact
            )
        )
