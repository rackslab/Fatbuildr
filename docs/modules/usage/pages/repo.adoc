...
#PRESCRIPT_DEPS@distributions:el8,el9 rpm-build-golang
...
* `rpm-build-golang` package is temporarily installed by Fatbuildr in build
  environments for _el8_ and _el9_ distributions.
